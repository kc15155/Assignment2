...
public class IterativeTest {
    ...
    public static void main(String[] args) {
        ...
        final ActorThreadPool pool = new ActorThreadPool(threads);
        ...
        for(int j = 1; j <= numOfActors; j++){
            ...
            final String currentActorName = "Actor" + j;
            PrivateState actor = new PrivateState() {};
            final Collection<Action<String>> actions = new LinkedList<Action<String>>();
            final Action<String> bigAction = new Action<String>() {
                @Override
                protected void start() {
                    ...
                    for(int i = 1; i <= actionsPerActor - 1; i++){
                        ...
                        sendMessage(subAction, nextActor, pool.getPrivateStates(nextActor));
                    }
